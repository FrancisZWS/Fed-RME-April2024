...
class ExperimentSet(gsim.AbstractExperimentSet):
    ...
    def experiment_1005(self):
        ...
        map_generator = GudmundsonMapGenerator(
            tx_power=np.array([[11, 5]]), #dBm
            b_shadowing=True,
            num_precomputed_shadowing_mats=30000, #400000,
            v_central_frequencies=v_central_freq)
        ...
        for i in np.arange(0, a_n_walkers.size):
            ...
            if not train_autoencoder: # If we do not wish to train the autoencoder, load the weights from storage
                estimator_1 = AutoEncoderEstimatorFed(
                    ...
                    bases_vals=map_generator.m_basis_functions,
                    n_filters=filters,
                    #weight_file='/home/aolihovik/Downloads/Teganya/work/dac_pytorch/python/output/autoencoder_experiments/savedWeights/1004_400k/weights.h5', #'output/autoencoder_experiments/savedWeights/weights_Fed.h5',
                    weight_file='/home/aolihovik/Downloads/Teganya/work/dac_pytorch/python/output/autoencoder_experiments/savedWeights/weights.h5',
                ...
                estimator_1 = AutoEncoderEstimatorFed( # From autoencoder_estimator_4.py
                    n_pts_x=map_generator.n_grid_points_x,
                    n_pts_y=map_generator.n_grid_points_y,
                    arch_id=architecture_id,
                    c_length=code_length,
                ...
                # Plot training results: losses and visualize codes if enabled
                #ExperimentSet.plot_train_and_val_losses(history, exp_num)
                ExperimentSet.plot_train_and_val_losses_fed(history, exp_num, n_epochs, plot_all=True, fpath='/home/aolihovik/Downloads/Teganya/work/dac_pytorch/python/output/autoencoder_experiments/savedWeights/' + a_fpath[i])
            ...
            estimator_2 = AutoEncoderEstimatorFed(
                ...
                bases_vals=map_generator.m_basis_functions,
                n_filters=filters,
                weight_file='/home/aolihovik/Downloads/Teganya/work/dac_pytorch/python/output/autoencoder_experiments/savedWeights/10w_2000s_100e_20sb_fedTest/weights_Fed.h5', #'output/autoencoder_experiments/savedWeights/weights_Fed_Test.h5',
                load_all_weights=None)
            ...
            estimator_3 = AutoEncoderEstimatorFed(
                ...
                bases_vals=map_generator.m_basis_functions,
                n_filters=filters,
                weight_file='/home/aolihovik/Downloads/Teganya/work/dac_pytorch/python/output/autoencoder_experiments/savedWeights/1w_2000s_100e_20sb/weights.h5', #'output/autoencoder_experiments/savedWeights/weights_Fed_Test.h5',
                load_all_weights=None)
            ...
            estimator_4 = AutoEncoderEstimatorFed(
                ...
                bases_vals=map_generator.m_basis_functions,
                n_filters=filters,
                weight_file='/home/aolihovik/Downloads/Teganya/work/dac_pytorch/python/output/autoencoder_experiments/savedWeights/2w_4000s_100e_10sb_fedTest_2/weights_Fed.h5',
            ...
            estimator_5 = AutoEncoderEstimatorFed(
                ...
                bases_vals=map_generator.m_basis_functions,
                n_filters=filters,
                weight_file='/home/aolihovik/Downloads/Teganya/work/dac_pytorch/python/output/autoencoder_experiments/savedWeights/2w_20000s_100e_2sb_InitSame_fedTest/weights_Fed.h5',
                # 'output/autoencoder_experiments/savedWeights/weights_Fed_Test.h5',
                load_all_weights=None)
    ...
    def experiment_10059(self):
        ...
        estimator_1 = AutoEncoderEstimatorFed(
            ...
            bases_vals=map_generator.m_basis_functions,
            n_filters=filters,
            weight_file='/home/aolihovik/Downloads/Teganya/work/dac_pytorch/python/output/autoencoder_experiments/savedWeights/1004_400k/weights.h5',
            load_all_weights=None)
        ...
        estimator_2 = AutoEncoderEstimatorFed(
            ...
            bases_vals=map_generator.m_basis_functions,
            n_filters=filters,
            weight_file='/home/aolihovik/Downloads/Teganya/work/dac_pytorch/python/output/autoencoder_experiments/savedWeights/10w_2000s_100e_20sb_fedTest/weights_Fed.h5',
            load_all_weights=None)
        ...
        estimator_3 = AutoEncoderEstimatorFed(
            ...
            bases_vals=map_generator.m_basis_functions,
            n_filters=filters,
            weight_file='/home/aolihovik/Downloads/Teganya/work/dac_pytorch/python/output/autoencoder_experiments/savedWeights/1w_2000s_100e_20sb/weights.h5',
            load_all_weights=None)
        ...
        estimator_2 = AutoEncoderEstimatorFed(
            ...
            bases_vals=map_generator.m_basis_functions,
            n_filters=filters,
            weight_file='/home/aolihovik/Downloads/Teganya/work/dac_pytorch/python/output/autoencoder_experiments/savedWeights/min_fed/test_26_1w_200s_2e_3sb/weights.h5',
            load_all_weights=None)
        ...
        estimator_3 = AutoEncoderEstimatorFed(
            ...
            bases_vals=map_generator.m_basis_functions,
            n_filters=filters,
            weight_file='/home/aolihovik/Downloads/Teganya/work/dac_pytorch/python/output/autoencoder_experiments/savedWeights/min_fed/test_26_2w_200s_2e_3sb/weights.h5',
            load_all_weights=None)
        ...
        estimator_4 = AutoEncoderEstimatorFed(
            ...
            bases_vals=map_generator.m_basis_functions,
            n_filters=filters,
            weight_file='/home/aolihovik/Downloads/Teganya/work/dac_pytorch/python/output/autoencoder_experiments/savedWeights/min_fed/test_26_5w_200s_2e_3sb/weights.h5',
            # 'output/autoencoder_experiments/savedWeights/weights_Fed_Test.h5',
            load_all_weights=None)
        ...
        estimator_5 = AutoEncoderEstimatorFed(
            ...
            bases_vals=map_generator.m_basis_functions,
            n_filters=filters,
            weight_file='/home/aolihovik/Downloads/Teganya/work/dac_pytorch/python/output/autoencoder_experiments/savedWeights/min_fed/test_26_10w_200s_2e_3sb/weights.h5',
            # 'output/autoencoder_experiments/savedWeights/weights_Fed_Test.h5',
            load_all_weights=None)
    ...
    def experiment_100592(self):
        ...
        results_parent_path = '/home/aolihovik/Downloads/Teganya/work/dac_pytorch/python/output/autoencoder_experiments/savedWeights/auto/'
        ...
        for i in np.arange(0, a_n_walkers.size):
            ...
            if not train_autoencoder:  # If we do not wish to train the autoencoder, load the weights from storage
                ...
                ExperimentSet.plot_train_and_val_losses_fed(history, exp_num, n_epochs, plot_all=True,
                                                            fpath='/home/aolihovik/Downloads/Teganya/work/dac_pytorch/python/output/autoencoder_experiments/savedWeights/' +
                                                                  a_fpath[i])
