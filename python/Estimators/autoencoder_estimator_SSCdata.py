...
class AutoEncoderEstimatorFedSSC(BemMapEstimator):
    """
       Arguments:
    ...
    def __init__(self,
                 ...
                 n_walkers=2,
                 **kwargs):
        super(AutoEncoderEstimatorFedSSC, self).__init__(**kwargs)
        ...
        self.map_list = scipy.io.loadmat(map_dir)['Traindata'][0]
    ...
    def train_fed(self,
        ...
        for ind_s_batch in range(n_super_batches):
            ...
            l_rate = learning_rate * ((0.95)**(ind_s_batch/100) ) # AO: Slower learning rate reduction
    ...
    def train_one_batch(self,
        ...
        def process_a_mat_map(ind_map, pt_map = None, pm_meta_map = None, pt_ch_power = None, pt_sampled_map=None, pm_mask=None):
            """
            Weishan: Modified from process_one_map, for matlab data, for SSC data
            ind_map: map index in the list/mat file
