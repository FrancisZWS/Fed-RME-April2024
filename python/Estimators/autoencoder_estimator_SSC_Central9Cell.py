...
class AutoEncoderEstimatorSSC_Central9Cell(BemMapEstimator):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(AutoEncoderEstimatorSSC_Central9Cell, self).__init__(**kwargs)
    ...
    def train_one_batch(self,
        ...
        def process_a_mat_map(ind_map, pt_map = None, pm_meta_map = None, pt_ch_power = None, pt_sampled_map=None, pm_mask=None):
            ...
            if pt_map is None: # if not prepared, generate one; if prepraed, just use it
                ...
                m_meta_map = np.zeros((self.n_grid_points_x,self.n_grid_points_x))
